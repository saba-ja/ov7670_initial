...
#
# Generated by Vivado on Sat Dec 01 14:28:01 PST 2018
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/saba/Documents/workstation4_image_processing/project_1/project_1.cache/compile_simlib/modelsim"
  fi
